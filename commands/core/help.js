...
module.exports = {
    ...
    async execute({ client, inter }) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(await Translate('This code comes from a <ziad> project.<\n>The use of this one is possible while keeping the credits for free.<\n>If you want to remove the credits join the Discord support server. <[here](https://discord.gg/YCK8KxDAHG)>)'))
